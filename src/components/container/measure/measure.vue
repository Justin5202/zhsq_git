...
export default {
    ...
    methods: {
        ...
        drawLine(e) {
            ...
            var distanceArray = this.Measure.measureLine.linestring.geometry
                .coordinates;
        ...
        drawPlane(e) {
            ...
            var area = turf.area(
                turf.polygon(this.Measure.measurePlane.polygon.geometry.coordinates)
            );
            if (area > 1000000) {
        ...
        ...mapActions(["setMeasurNum", "setDrawPanelType"])
    }
};
</script>
